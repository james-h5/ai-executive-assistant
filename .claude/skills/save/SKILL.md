...
## Purpose
Keep a running record of what's been done across all active projects, so that when James asks "what's next?" the assistant already knows exactly where things stand â€” no re-explaining needed.

## Step 1: Identify What Was Done

Extract from James's message:
- **What was completed** â€” the specific action or deliverable
- **Which project it belongs to** â€” map to the relevant project folder:
...
- **Next:** [The single most logical next action â€” be specific]
```

The **Next** field is the most important â€” it must be a concrete, actionable step, not vague direction.
...
Reply with this format â€” keep it short:

---

**Saved:** [What was logged, one line]

**Next up:** [The concrete next action â€” specific enough to act on immediately]
...
## Output Rules
- The "Next up" must be the single most important next action â€” not a list
