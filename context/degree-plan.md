...
- Regular-semester credit still to complete: 264cp (180cp engineering fixed units/electives as above, minus the 24cp swapped from 4→6 AE electives already folded in, + 60cp business excl. MGB130 — see table below for the exact placement)
